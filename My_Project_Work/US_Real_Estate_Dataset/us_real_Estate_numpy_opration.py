...
broked_by,price,city ,house_size = np.genfromtxt('My_Project_Work/US_Real_Estate_Dataset/RealEstate-USA.csv',
                                                     delimiter=',', usecols=(0,2,7,10), unpack=True, dtype=None,skip_header=1,invalid_raise=False)
print(broked_by)
print(price)
print(city)
print(house_size)
...
# real_estate price  - maths operations
...
addition = city + price
subtraction = city - price
multiplication = city * price
division = city / price

print(" real_estate Long - lat - Addition:", addition)
...
print("Zreal_estate Price - div - pie  = Base-10 logarithm values:", log10_array)
...
#real_estate Long Plus Lat - 2 dimentional arrary
D2LongLat = np.array([city,
                  price])

print ("real_estate Long Plus Lat - 2 dimentional arrary - " ,D2LongLat)

# check the dimension of array1
print("real_estate Long Plus Lat - 2 dimentional arrary - dimension" , D2LongLat.ndim) 
# Output: 2

# return total number of elements in array1
print("real_estate Long Plus Lat - 2 dimentional arrary - total number of elements" ,D2LongLat.size)
# Output: 6

# return a tuple that gives size of array in each dimension
print("real_estate Long Plus Lat - 2 dimentional arrary - gives size of array in each dimension" ,D2LongLat.shape)
# Output: (2,3)

# check the data type of array1
print("real_estate Long Plus Lat - 2 dimentional arrary - data type" ,D2LongLat.dtype) 
# Output: int64

# Splicing array
D2LongLatSlice=  D2LongLat[:1,:5]
print("real_estate Long Plus Lat - 2 dimentional arrary - Splicing array - D2LongLat[:1,:5] " , D2LongLatSlice)
D2LongLatSlice2=  D2LongLat[:1, 4:15:4]
print("real_estate Long Plus Lat - 2 dimentional arrary - Splicing array - D2LongLat[:1, 4:15:4] " , D2LongLatSlice2)



# Indexing array
D2LongLatSliceItemOnly=  D2LongLatSlice[0,1]
print("real_estate Long Plus Lat - 2 dimentional arrary - Index array - D2LongLatSlice[1,5] " , D2LongLatSliceItemOnly)
D2LongLatSlice2ItemOnly=  D2LongLatSlice2[0, 2]
print("real_estate Long Plus Lat - 2 dimentional arrary - index array - D2LongLatSlice2[0, 2] " , D2LongLatSlice2ItemOnly)
